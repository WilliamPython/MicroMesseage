				...
				<table class="tab1">
					<tbody>
						<tr>
							...
							<td><input type="text" name="command" class="allInput" value="${command}" /></td>
							<td width="90" align="right">描述：</td>
							<td><input type="text" name="description" class="allInput" value="${description}" /></td>
						...
						<tbody>
							...
							<c:forEach items="${messageList}" var="message"
								...
								<tr <c:if test="${(status.index +1)%2==0}">style="background-color:#ECF6EE;"</c:if>>
									...
									<td><a href="#">修改</a>&nbsp;&nbsp;&nbsp;
									    <input type="hidden" name="id1" value="${message.id}"/> 
